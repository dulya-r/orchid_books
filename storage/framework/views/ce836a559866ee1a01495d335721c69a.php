...
<section class="relative flex flex-col items-center justify-center text-center min-h-screen bg-purple-600">
    <img src="<?php echo e(asset('images/home-bg.jpg')); ?>" alt="Cover Image" class="w-full h-full object-cover absolute inset-0">
</section>
        ...
        <div class="max-w-4xl mx-auto text-center">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-8">
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="block px-6 py-2 bg-purple-600 text-white rounded shadow">Login</a>
                </div>
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="block px-6 py-2 bg-purple-600 text-white rounded shadow">Register</a>
                </div>
            </div>
        </div>
    </section>
...
<?php /**PATH C:\xampp\htdocs\book_store\resources\views/welcome.blade.php ENDPATH**/ ?>