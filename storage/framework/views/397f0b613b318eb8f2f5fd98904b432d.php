...
<body class="bg-purple-100 text-gray-900">
    ...
    <section class="relative flex flex-col items-center justify-center text-center min-h-screen bg-purple-600">
        <img src="<?php echo e(asset('images/services-bg.jpg')); ?>" alt="Services Background Image" class="w-full h-full object-cover absolute inset-0">
    </section>
...
<section class="bg-white py-16">
  <div class="max-w-4xl mx-auto text-center">
      ...
      <div class="container-intro grid grid-cols-1 sm:grid-cols-2 gap-8 mt-8">
          <!-- Author Events Image -->
          <div class="image">
              <img src="<?php echo e(asset('images/author-events-page.jpg')); ?>" alt="Author Events" class="w-full h-auto rounded-lg shadow-lg"/>
          </div>
          <div class="text">
          ...
          <!-- Gift Cards Image -->
          <div class="image">
              <img src="<?php echo e(asset('images/gift-card-page.jpg')); ?>" alt="Gift Cards" class="w-full h-auto rounded-lg shadow-lg"/>
          </div>
          <div class="text">
...
<?php /**PATH C:\xampp\htdocs\book_store\resources\views/services.blade.php ENDPATH**/ ?>