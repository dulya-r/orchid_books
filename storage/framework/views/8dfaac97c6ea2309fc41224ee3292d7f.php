    ...
    <nav class="bg-purple-600 text-white p-4">
        <div class="flex justify-between items-center w-full">
            ...
            <div class="hidden lg:flex space-x-6 ml-10">
                <a href="<?php echo e(route('admin.manageUsers')); ?>" class="text-lg hover:underline">Manage Users</a>
                <a href="<?php echo e(route('admin.manageBooks')); ?>" class="text-lg hover:underline">Manage Books</a>
    ...
    <div class="container mx-auto my-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white p-6 shadow-lg rounded-lg">
                ...
                <p class="text-3xl font-bold text-purple-600"><?php echo e($usersCount); ?></p>
            </div>

            <!-- Books Card -->
            <div class="bg-white p-6 shadow-lg rounded-lg">
                <h3 class="text-xl font-semibold text-purple-600">Books</h3>
                <p class="text-3xl font-bold text-purple-600"><?php echo e($booksCount); ?></p>
            </div>

            <!-- Pending Orders Card -->
            <div class="bg-white p-6 shadow-lg rounded-lg">
                <h3 class="text-xl font-semibold text-purple-600">Pending Orders</h3>
                <p class="text-3xl font-bold text-purple-600"><?php echo e($pendingOrders); ?></p>
            </div>

            <!-- Delivered Orders Card -->
            <div class="bg-white p-6 shadow-lg rounded-lg">
                <h3 class="text-xl font-semibold text-purple-600">Delivered Orders</h3>
                <p class="text-3xl font-bold text-purple-600"><?php echo e($deliveredOrders); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="overflow-x-auto">
        <table class="min-w-full bg-white shadow-md rounded-lg">
            ...
            <tbody>
                ...
                <tr class="border-b">
                    <td class="py-3 px-4 text-center"><?php echo e($order->id); ?></td>
                    <td class="py-3 px-4 text-center"><?php echo e($order->name); ?></td>
                    <td class="py-3 px-4 text-center"><?php echo e($order->email); ?></td> <!-- Display Email -->
                    <td class="py-3 px-4 text-center"><?php echo e($order->phone); ?></td> <!-- Display Phone -->
                    <td class="py-3 px-4 text-center">$<?php echo e(number_format($order->total, 2)); ?></td>
                    <td class="py-3 px-4 text-center">
                        <span class="px-2 py-1 rounded-lg text-white <?php echo e($order->status == 'pending' ? 'bg-red-500' : 'bg-green-700'); ?>">
                            <?php echo e(ucfirst($order->status)); ?>

                        </span>
                    </td>
                    <td class="py-3 px-4 text-center">
                        <form method="POST" action="<?php echo e(route('admin.updateOrderStatus', $order->id)); ?>">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\book_store\resources\views/admin/home.blade.php ENDPATH**/ ?>